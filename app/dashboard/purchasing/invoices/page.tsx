...
export default function PurchaseInvoicesPage() {
  ...
  const fetchInvoices = async () => {
    try {
      ...
      const url = `${env.apiBase}/api/v1/purchasing/invoices${queryString ? `?${queryString}` : ''}`
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500 mt-1">Manage your purchase invoices and payments</p>
        </div>
        {isAccountantOrAdmin && (
          <Link href="/dashboard/purchasing/invoices/new">
            <Button>
                ...
                <TableBody>
                  {invoices.map((invoice) => (
                    <TableRow key={invoice.id}>
                      ...
                      <TableCell className="text-right">
                        <Link href={`/dashboard/purchasing/invoices/${invoice.id}`}>
